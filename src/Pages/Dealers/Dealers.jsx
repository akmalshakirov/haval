...
import HAVAL_DEALER_BG from "../../Images/haval-dealer.jpg";
import "./Dealers.css";
    ...
    const locations = [
        {
            ...
            description:
                "Toshkent sh., Yakkasaroy tumani, Bobur ko'chasi, 87B/1",
        ...
        },
        {
            ...
            name: "HAVAL Qarshi",
            description:
                "Qashqadaryo viloyati, Qarshi shahar, Jayhun ko'chasi, 33",
            coordinates: { lat: 41.00868115192557, lng: 71.64229932834473 },
        },
        {
            id: 13,
    ...
    return (
        <>
            ...
            <section className='dealers'>
                        ...
                        <div
                            ...
                            {locations.map((location) => (
                                <div
                                    ...
                                    className='dealers-item-map'>
                                    <h3
                                        style={{ margin: 0 }}
                                        className='dealers-list-item-title'>
                                        {location.name}
                                    </h3>
                                    <p
                                        style={{ margin: "5px 0 0" }}
                                        className='dealers-list-item-address'>
                ...
                <div className='dealers-bg'>
                    <div>
                        <img src={HAVAL_DEALER_BG} alt='haval-dealer' />
                        <span></span>
                    </div>
                    <div>
                        <h1>
                            HAVALning dileri bo'lishni <br /> istaysizmi?
                        </h1>

                        <p>
                            So'rovnomani to'ldiring va brend hamkoriga aylaning
                        </p>
